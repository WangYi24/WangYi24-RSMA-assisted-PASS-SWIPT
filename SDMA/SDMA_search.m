function [SumRate_best,Loc_PA_best,W_best] = SDMA_search(K,J,N,P_dBm_max,Emin,Loc_IDR,Loc_EHR,D_x,D_y,d,sigma2)
%搜索天线位置，每个位置做一次优化
%% parameter
...
for iter = 1:maxiter
    ...
    for n = 1:N
        ...
        for xn = candidates
            ...
            % 内层固定PA位置，优化W                  
            [W_p, SumRate] = SDMA_wmmse(h_IDR,h_EHR,sigma2, P_max,Emin);
